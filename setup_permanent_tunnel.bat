...
:: Ask for tunnel name
set /p TUNNEL_NAME="أدخل اسم الـ Tunnel (مثال: lmina-backend): "
if "%TUNNEL_NAME%"=="" set TUNNEL_NAME=lmina-backend
...
echo    cloudflared tunnel route dns %TUNNEL_NAME% lmina.yourdomain.com
echo.
...
if /i "%START_NOW%"=="y" (
    ...
    start "LMINA Named Tunnel" cmd /c "%START_SCRIPT%"
    echo.
